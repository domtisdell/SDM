...
def process_mermaid_diagrams(md_content, temp_dir):
    ...
    def replace_mermaid(match):
        ...
        if success and os.path.exists(image_path):
            ...
            return f'<div class="mermaid-diagram"><p><em>[Diagram {diagram_counter}: Mermaid diagram - see original document for interactive version]</em></p></div>'
...
def convert_md_to_pdf_with_diagrams(md_file_path, output_dir):
    ...
    try:
        ...
        pdf_filename = Path(md_file_path).stem + '_with_diagrams.pdf'
...
def main():
    ...
    output_dir = '/home/dominic/wsl_coding/projects/SDM/forecasts/pdf_with_diagrams'
    ...
    print("Note: First run will download Chromium for diagram rendering (this may take a moment)...")
    ...
    print(f"  PDFs with diagrams saved to: {output_dir}")


if __name__ == "__main__":
    # Download chromium if needed (first run)
    import pyppeteer
