...
graph TD
    ...
    H[Exports of Flat Products<br/>Est. 295 kt]
    I[Exports of Long Products<br/>Est. 196 kt]
...
## Trade Flow Categories - 2020

| Trade Category | Product Type | Example Volume Estimate (kt) |
|----------------|--------------|-------------------------------|
| Flat Products | Sheets, Strips, Coils | 2951 |
| Long Products | Bars, Rods, Rails | 1964 |
