# WSA Steel Use Metrics Hierarchy - 2050
...
graph TD
    ...
    B[Apparent Steel Use<br/>crude steel equivalent<br/>7098 kt]
    C[Apparent Steel Use<br/>finished steel products<br/>6407 kt]
    D[True Steel Use<br/>finished steel equivalent<br/>10630 kt]
...
## Steel Use Metrics Comparison - 2050

| WSA Consumption Metric | Volume (kt) | Calculation Method | Purpose |
|------------------------|-------------|-------------------|---------|
| **Apparent Steel Use (crude steel equivalent)** | 7098 | Production + Imports - Exports | Standard trade balance |
| **Apparent Steel Use (finished steel products)** | 6407 | Finished products basis | Direct consumption |
| **True Steel Use (finished steel equivalent)** | 10630 | Adjusted for indirect trade | Comprehensive consumption |
